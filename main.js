...
//         const quizCardContainer = document.getElementByIdById('quiz-cards');
...
//                 .then(data => {
//                     if (data.count === 0) {
//                         quizCardContainer.innerHTML = `<p>Aucun quiz trouvé</p>`;
//                     } else {
...
//                     quizCardContainer.innerHTML = `<p style="color: red;">Erreur réseau ou serveur</p>`;
//                 });
//             }
//     }
